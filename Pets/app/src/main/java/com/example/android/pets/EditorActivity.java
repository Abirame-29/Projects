...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet(){
        ...
        values.put(PetEntry.COLUMN_WEIGHT,weightValue);
    ...
    private void deletePet() {
        if(mCurrentPetUri!=null) {
            int deletedPets = getContentResolver().delete(mCurrentPetUri, null, null);
            if (deletedPets == 0)
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if(data.moveToFirst()){
            ...
            mWeightEditText.setText(Integer.toString(data.getInt(data.getColumnIndex(PetEntry.COLUMN_WEIGHT))));
            switch (data.getInt(data.getColumnIndex(PetEntry.COLUMN_GENDER))){
